package com.spurtreetech.sttarter.lib.helper;//add your package name here example: package com.example.dbm;
...
import com.spurtreetech.sttarter.lib.provider.STTSQLiteOpenHelper;
