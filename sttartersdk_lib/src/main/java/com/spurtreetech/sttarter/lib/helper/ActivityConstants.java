...
public class ActivityConstants {
  ...
  static final String TAG = "STT Android";

  /*Default values **/

  /** Default QOS value **/
  // Currently Qos of 2 is throwing error from client side as the persistance class is throwing EOFException, not tested with Qos of 1
  static final int defaultQos = 1;
  /** Default timeout*/
  static final int defaultTimeOut = 1000;
  /** Default keep alive value*/
  static final int defaultKeepAlive = 30;
