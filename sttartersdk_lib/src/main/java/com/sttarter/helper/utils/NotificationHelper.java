...
public class NotificationHelper {
    ...
    public static void displayNotification(String groupsString) {
        ...
        try {
            notificationManager = (NotificationManager) STTarterManager.getInstance().getContext().getSystemService(Context.NOTIFICATION_SERVICE);
            pIntent = PendingIntent.getActivity(STTarterManager.getInstance().getContext(), 0, intent, PendingIntent.FLAG_CANCEL_CURRENT);
        ...
        try {
            builder = new NotificationCompat.Builder(STTarterManager.getInstance().getContext());
        } catch (STTarterManager.ContextNotInitializedException e) {
            e.printStackTrace();
        }
        try {
            builder.setContentTitle(STTarterManager.getInstance().getContext().getResources().getString(R.string.app_name))
        ...
        try {
            builder.setContentTitle(STTarterManager.getInstance().getContext().getResources().getString(R.string.app_name))
                    ...
                    .setStyle(new NotificationCompat.InboxStyle()
                            ...
                            //.addLine("Line 2")
                            .setSummaryText("Total unread messages")
                            .setBigContentTitle(STTarterManager.getInstance().getContext().getResources().getString(R.string.app_name)))
                    .setNumber(2)
                    //.setSmallIcon(R.mipmap.autosense)
                    .setCategory(Notification.CATEGORY_EVENT)
                    .setGroupSummary(true)
